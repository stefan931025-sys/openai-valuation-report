...
def create_report():
    ...
    # Subtitle with multi_cell fix to allow beautiful wrapping
    pdf.set_font("Helvetica", "B", 11)
    pdf.set_text_color(100, 100, 100)
    pdf.multi_cell(170, 6, "A Critical Macro-Financial Analysis of Rupee Stabilization, Capital Inflows, and Systemic Trade-Offs", align="L")
    ...
    pdf.add_page() # Clean layout transition to page 2
